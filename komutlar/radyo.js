...
const radio = {
    "karisik": "http://17773.live.streamtheworld.com/VIRGIN_RADIO_SC",
    ...
    "efkarlı": "http://www.radyodinle.fm/#best-fm-98-4"
      ...
      if (!args) return msg.channel.send(':x: | Bir Radyo Seçin : **karisik**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')

        if(!radio[args]) return msg.channel.send(':x: | Lütfen Yandaki Radiolardan Birini Seç : **karisik**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
