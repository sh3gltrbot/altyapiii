...
exports.run = async (bot, message, args) => {
    ...
    if (!args[0]) return message.channel.send(new Discord.RichEmbed().setColor('RANDOM').setAuthor(message.guild.name, message.guild.iconURL).addField('Kullanım;', `:white_check_mark: **l!otorol <@rol>**`).setFooter('SH3GLTR Bot', bot.user.avatarURL).setTimestamp());
